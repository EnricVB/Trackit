...
import dev.enric.core.consumer.SudoArgsConsumer
...
class CommitCommand : TrackitCommand() {
     ...
     */
    @Option(names = ["--tag", "-t"], description = ["Adds a tag to the commit"], arity = "0..*")
    ...
    @Option(
        ...
        parameterConsumer = SudoArgsConsumer::class,
        arity = "2",
        required = false
    )
